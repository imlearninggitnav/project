      ...
      try {
        ...
        const response = await fetch('http://localhost:8080/api/v1/dalle  ', 
        {
          ...
          headers: {
            ...
            //'Authorization': 'Bearer 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',
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          Create imaginative and visually stunning images through AImage
       ...
       <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>** Once you have created
          the image you want, you can download it by clicking the download button below **</p>
          <a href= {form.photo} download>
          <button
            type="button"
